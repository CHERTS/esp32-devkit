...
if [ $DOWNLOAD -gt 0 ]; then
  ...
  echo "GCC"
  wget -c http://programs74.ru/get.php?file=esp32-$GCC -P $XTDLP
  echo "Newlib"
  wget -c http://programs74.ru/get.php?file=esp32-$NEWLIB -P $XTDLP
  echo "Binutils"
  wget -c http://programs74.ru/get.php?file=esp32-$BINUTILS -P $XTDLP
