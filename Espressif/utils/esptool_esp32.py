...
#
# This is modified by Espressif employees to support flashing on the ESP31 chip, but is ENTIRELY
# UNSUPPORTED either by the original author or by Espressif. Use at your own risk.
# Known bugs: In some configurations, it's necessary to run this tool twice if it fails to enter
# flash mode the first time.
#

#
# ESP32 ROM Bootloader Utility
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description = 'ESP32 ROM Bootloader Utility', prog = 'esptool')
